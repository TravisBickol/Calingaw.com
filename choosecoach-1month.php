...
<html>
  ...
  <body style="padding-top: 200px;">
    ...
    ?>
    <div class="header">
      <a href="user-member-1month-nocoach.php"><img class="logo" src="images/logo.PNG"></a>
      <div class="user">
        ...
        <div class="dropdown-content">
          <a href="userprofile1month-nocoach.php">Profile</a>
          <a href="#">Settings</a>
    ...
    <div id="sub-plans" class="sub-plans">
      <form action="pendingenroll.php" method="POST" class="sub-plan-box">
    ...
    <div id="carlosmoment" style="display:none">
      <form action="pendingenroll.php" method="POST" class="choosecoach-info">
        ...
        <input style="right: 20px; margin: 30px; background-color: blue; color: white; padding: 10px 20px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; position: absolute; bottom: 0;" type="submit" name="submit" value="Next" onclick="showAlertAndRedirect()">
      </form>
    </div>
    ...
    <div id="stillamoment" style="display:none">
      ...
      <script>
        function showAlertAndRedirect() {
          ...
          window.location.href = "pendingenroll.php";
        }
      </script>
    </div>
  </body>
