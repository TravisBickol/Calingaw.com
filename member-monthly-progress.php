<html>
  ...
  <body style="padding-top: 250px; margin: 0;">
   ...
   <div class="header">
      <a href="user-member.php"><img class="logo" src="images/logo.PNG"></a>
      <div class="user">
    ...
    <div class="stream">
      <div class="user-middle">
        ...
        <a style="text-decoration: none; color: black;" href="member-monthly.php"><label >Stream</label></a>
        </div>
        <div style="height:50px; border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: white;">
        <label >Tasks</label>
        </div>
     ...
     <div class="your-progress">
      <label>Enthusiast Progress</label>
     </div>
  </body>
</html>
