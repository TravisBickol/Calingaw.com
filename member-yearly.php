<html>
  ...
  <body style="padding-top: 250px; margin: 0;">
    ...
    <div class="header">
      <a href="user-member-12months.php"><img class="logo" src="images/logo.PNG"></a>
      <div class="user">
        ...
        <div class="dropdown-content">
          <a href="userprofile12months.php">Profile</a>
          <a href="#">Settings</a>
    ...
    <div class="sidebar">
      <div class="nav">
        <div style="width: 100%; border-left-width: 20px; border-left-style: solid; border-color: orange; position: relative; display: flex; align-items: center; justify-content: center; top: 50px; height: 80px;">
          <i style="font-size: 40px; cursor: pointer; position: absolute; left: 40px; " class="fa-solid fa-rocket"></i>
        </div>
    ...
    <div class="stream">
      <div class="user-middle">
        <div style="height:50px; border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: orange;">
        <label >Stream</label>
        </div>
        <div style="height:50px; border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: white;">
        <a href="#" style="text-decoration: none; color: black;"><label >Tasks</label></a>
        </div>
        <div style="height:50px; border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: white;">
        <a href="#" style="text-decoration: none; color: black;"><label >Enthusiasts</label></a>
        </div>
        <div style="height:50px; border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: white;">
        <a style="text-decoration: none; color: black;" href="member-monthly-coaches.php"><label >Coaches</label></a>
        </div>
      </div>
    </div>
    <div class="box-container">
      ...
      <div class="vertical-flex">
        ...
        <div class="task">
          ...
          <label for="" style="font-family: Arial; font-size: 25px; position: absolute; left: 100px; top: 30px;  cursor: pointer;">Do 50 crunches</label>
        ...
        <div style="margin-top: 20px;" class="task" >
          <i class='fas fa-tasks' style="font-size: 35px; position: absolute; left: 30px; top: 30px; cursor: pointer;"></i>
          <label for="" style="font-family: Arial; font-size: 25px; position: absolute; left: 100px; top: 30px; cursor: pointer;">Do 2 mins plank</label>
          <i class='fas fa-ellipsis-v' style="font-size: 35px; position: absolute; right: 30px; top: 30px; cursor: pointer;"></i>
        </div>
        <div style="margin-top: 20px;" class="task">
          <i class='fas fa-tasks' style="font-size: 35px; position: absolute; left: 30px; top: 30px; cursor: pointer;"></i>
          <label for="" style="font-family: Arial; font-size: 25px; position: absolute; left: 100px; top: 30px; cursor: pointer;">do 20 russian twists</label>
          <i class='fas fa-ellipsis-v' style="font-size: 35px; position: absolute; right: 30px; top: 30px; cursor: pointer;"></i>
        </div>
        <div style="margin-top: 20px;" class="task">
          <i class='fas fa-tasks' style="font-size: 35px; position: absolute; left: 30px; top: 30px; cursor: pointer;"></i>
