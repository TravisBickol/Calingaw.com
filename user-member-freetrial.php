  ...
  ?>
    ...
    <div class="intro2">
      ...
      <div class="btn-user-type">
        <a href="subplanforfreetrials.php"><button class="user-buttons">Be A REAL Member</button></a>
        <a href="member-freetrial.php"><button class="user-buttons">Go to FREE Workout Space</button></a>
      </div>
      <div class="intro-box">
